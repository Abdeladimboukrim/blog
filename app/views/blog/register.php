...
<div class="row">
    <div class="col-md-6 mx-auto mt-4">
        <div class="card card-body p-3">
            ...
            <form action="<?php echo URLROOT; ?>blog/register" method="post">
                <!-- name input  -->
                <div class="form-group">
                    <span for="name">Name <sup>*</sup></span>
                    <input type="text" name="firstName" value="<?php echo $data['name'] ?>" class="form-control form-control-lg <?php echo (!empty($data['name_err']) ? 'is-invalid' : '') ?>">
                ...
                <div>
                    ...
                    <a href="<?php echo URLROOT; ?>blog/login" class="btn btn-secondary">Have you an account? Log in</a>
                </div>
